...
par_peaks <- get_peaks(par, annot = annot)
npar_peaks <- get_peaks(npar, annot = annot)
famlod_peaks <- get_peaks(famlod, annot = annot)
fampar_peaks <- get_peaks(fampar, annot = annot)
